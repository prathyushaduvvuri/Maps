...
public class Gui extends JFrame {
	...
	public JLabel lblStatusMessage;
...
******************/	
	...
	setResizable(false);
		...
		lblStatusMessage.setBounds(94, 494, 943, 102);
			...
			public void actionPerformed(ActionEvent e) { 
				...
				Thread t = new Thread(new Runnable() {
					...
					public void run() {
						...
						ColumnDeleteCSV columnDeleteCSV = new ColumnDeleteCSV(progressBar, lblStatusMessage); // New Object
																										// for
						// PerformAction class
						...
						try {
							columnDeleteCSV.obtainDirectoryListing(SourceDirectory, DestinationDirectory,
									textErrorColumn);
							String title = "Status";
							JOptionPane.showMessageDialog(null, "Succesfully Deleted Column CSV Files", title,
